...
public class StreamPractice {
    /**
     * Given a list of strings where each element contains one or more numbers:
     * input = {"5,30,100", "0,22,7", ...}
     * Returns the smallest even integer.
     * If no even numbers are found, throws a RuntimeException with the message:
